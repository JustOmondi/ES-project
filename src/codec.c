//Audio codec configuration functions
...
void codec_init()
{
	...
	PinInitStruct.GPIO_Speed = GPIO_Speed_100MHz;
	...
	//I2S_InitType.I2S_AudioFreq =  ((uint32_t)400);
	...
	I2C_InitType.I2C_ClockSpeed = 100000/*100000*/;
